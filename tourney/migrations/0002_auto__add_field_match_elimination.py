...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.elimination'
        db.add_column(u'tourney_match', 'elimination',
                      self.gf('django.db.models.fields.CharField')(default='BEST_THREE', max_length=12),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.elimination'
        db.delete_column(u'tourney_match', 'elimination')
