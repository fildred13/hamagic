...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.tourney'
        db.alter_column(u'tourney_group', 'tourney_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tourney.Tourney'], null=True))

    def backwards(self, orm):

        # Changing field 'Group.tourney'
        db.alter_column(u'tourney_group', 'tourney_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 5, 27, 0, 0), to=orm['tourney.Tourney']))
