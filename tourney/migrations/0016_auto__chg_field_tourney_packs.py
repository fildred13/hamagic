...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tourney.packs'
        db.alter_column(u'tourney_tourney', 'packs', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Tourney.packs'
        db.alter_column(u'tourney_tourney', 'packs', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'deck.deck': {
            ...
            'packs': ('django.db.models.fields.CharField', [], {'default': "'Unlimited'", 'max_length': '20'}),
