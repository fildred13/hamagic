...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Group'
        db.create_table(u'tourney_group', (
        ...
        db.send_create_signal(u'tourney', ['Group'])
        ...
        # Renaming column for 'Match.group' to match new field type.
        db.rename_column(u'tourney_match', 'group', 'group_id')
        # Changing field 'Match.group'
        db.alter_column(u'tourney_match', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tourney.Group']))
        # Adding index on 'Match', fields ['group']
        db.create_index(u'tourney_match', ['group_id'])


    def backwards(self, orm):
        # Removing index on 'Match', fields ['group']
        db.delete_index(u'tourney_match', ['group_id'])

        # Deleting model 'Group'
        db.delete_table(u'tourney_group')
        ...
        # Renaming column for 'Match.group' to match new field type.
        db.rename_column(u'tourney_match', 'group_id', 'group')
        # Changing field 'Match.group'
        db.alter_column(u'tourney_match', 'group', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
