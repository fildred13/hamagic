...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tourney_match', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tourney.Group'], null=True))

    def backwards(self, orm):

        # Changing field 'Match.group'
        db.alter_column(u'tourney_match', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 5, 27, 0, 0), to=orm['tourney.Group']))
