...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tourney.rr_num_advance'
        db.add_column(u'tourney_tourney', 'rr_num_advance',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tourney.rr_num_advance'
        db.delete_column(u'tourney_tourney', 'rr_num_advance')
