...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tourney.qr_rr_group_size'
        db.add_column(u'tourney_tourney', 'qr_rr_group_size',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=4),
                      keep_default=False)

        # Adding field 'Tourney.rr_group_size'
        db.add_column(u'tourney_tourney', 'rr_group_size',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tourney.qr_rr_group_size'
        db.delete_column(u'tourney_tourney', 'qr_rr_group_size')

        # Deleting field 'Tourney.rr_group_size'
        db.delete_column(u'tourney_tourney', 'rr_group_size')
