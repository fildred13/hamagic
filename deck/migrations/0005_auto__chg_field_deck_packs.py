...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deck.packs'
        db.alter_column(u'deck_deck', 'packs', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Deck.packs'
        db.alter_column(u'deck_deck', 'packs', self.gf('django.db.models.fields.CharField')(max_length=50))
