...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Deck.sideboard'
        db.delete_column(u'deck_deck', 'sideboard')

        # Deleting field 'Deck.main_deck'
        db.delete_column(u'deck_deck', 'main_deck')

        # Adding field 'Deck.deck_list'
        db.add_column(u'deck_deck', 'deck_list',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Deck.sideboard'
        db.add_column(u'deck_deck', 'sideboard',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Deck.main_deck'
        db.add_column(u'deck_deck', 'main_deck',
                      self.gf('django.db.models.fields.TextField')(default=datetime.datetime(2014, 5, 28, 0, 0)),
                      keep_default=False)

        # Deleting field 'Deck.deck_list'
        db.delete_column(u'deck_deck', 'deck_list')
