...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deck.tourney_bow_outs'
        db.add_column(u'deck_deck', 'tourney_bow_outs',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deck.tourney_bow_outs'
        db.delete_column(u'deck_deck', 'tourney_bow_outs')
